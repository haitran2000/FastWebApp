...
import { AtscadaChartDemoView } from './atscada-chartdemo-view.js'

export class AtscadaChartDemoElement extends HTMLElement {
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        this.view = new AtscadaChartDemoView(this.model, this);
...
customElements.define('atscada-chartdemo', AtscadaChartDemoElement);